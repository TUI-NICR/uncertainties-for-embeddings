...
""" --------------------------------------------------------------------------- BA_UE
This dummy is just used to differentiate DNet's version of Market from the normal one. 
It is mostly identical for the purposes of reading it.
"""
@DATASET_REGISTRY.register()
class MarketDNet(Market1501):
    pass