...
def triplet_loss(embedding, targets, margin, norm_feat, hard_mining, metric="euclidean", embedding_variance=None):
    ...
    if metric == "cosine" or (metric=="euclidean" and norm_feat):
        ...
        dist_mat = _compute_kl_divergence(embedding, embedding_variance, embedding, embedding_variance)
    elif metric == "js_divergence":
        dist_mat = _compute_js_divergence(embedding, embedding_variance, embedding, embedding_variance)
    elif metric == "bhatt_distance":
        dist_mat = _compute_bhatt_distance(embedding, embedding_variance, embedding, embedding_variance)
    elif metric == "wasserstein":
        dist_mat = _compute_wasserstein_distance(embedding, embedding_variance, embedding, embedding_variance)
    else:
