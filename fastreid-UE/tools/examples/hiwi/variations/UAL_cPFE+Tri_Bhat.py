...
def volatile_config(cfg):
    ...
    #cfg.OUTPUT_DIR = "/usr/scratch4/angel8547/results/variations/UAL_cPFE+Tri_Bhat"
    #cfg.TEST.EVAL_ENABLED_IN = "0,10,20,30,40,45-55,60,70,75,80,84,88,92,94,96,98,100-120"

    cfg.MODEL.LOSSES.NAME = ("MutualLikelihoodScoreLoss", "TripletLoss",)
    cfg.MODEL.LOSSES.TRI.METRIC = "bhatt_distance"
    cfg.MODEL.CROWN.NAME = "DummyCrown"
    cfg.SEED = 21001654
    ...
    if not is_test_run:
        ...
        cfg.MODEL.LOSSES.MLS.SCALE = 0.0001
