...
# bsub -gpu "num=1" -J "UAL[30-31]" -q "BatchGPU" -outdir /usr/scratch4/angel8547/results/UAL/%I -o /usr/scratch4/angel8547/results/UAL/%I/out.%J -e /usr/scratch4/angel8547/results/UAL/%I/err.%J python tools/hiwi/UAL.py
# bsub -gpu "num=1" -J "BUAL[101-105]" -q "BatchGPU" -outdir /usr/scratch4/angel8547/results/UAL/%I -o /usr/scratch4/angel8547/results/UAL/%I/out.%J -e /usr/scratch4/angel8547/results/UAL/%I/err.%J python tools/hiwi/UAL.py
# -------------------------------------------------------------
RUN_TYPE = "UAL"
...
def volatile_config(cfg):
    ...
    cfg.OUTPUT_DIR = "/data2/hpcuser/angel8547/results_backup_2024_03_13/UAL/%I" # change out_dir path when using HPC
    #cfg.MODEL.WEIGHTS = "/data2/hpcuser/angel8547/results_backup_2024_03_13/UAL/%I/model_best.pth" # only for eval
    ...
    if "%I" in cfg.MODEL.WEIGHTS:
        cfg.MODEL.WEIGHTS = cfg.MODEL.WEIGHTS.replace("%I", job_array_id)
...
def setup(args):
    ...
    try:
        ...
        dataset_path = f"/data2/hpcuser/angel8547/{cfg.DATASETS.NAMES[0]}"
