...
#SBATCH --output=/results_nas/ange8547/DNet/fastreid/fine_tune_from_PT__FU_euclid_rndsmpl/%a/slurm-%j.out

# specify job name that is seen in slurm info
#SBATCH --job-name=fine_tune_from_PT__FU_euclid_rndsmpl
...
def setup(args):
    ...
    cfg.run_type = "fine-Market-in_PT-from_PT+FU_euclid_rndsmpl"
