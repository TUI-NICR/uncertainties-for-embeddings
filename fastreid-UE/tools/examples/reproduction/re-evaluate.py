...
#SBATCH --output=/results_nas/ange8547/DNet/fastreid/fine_tune_from_PT_DNM__FU/%a/slurm-%j.out

# specify job name that is seen in slurm info
#SBATCH --job-name=fine_tune_from_PT_DNM__FU
...
def setup(args):
    ...
    cfg.DNM = 1
    cfg.run_type = "fine-DNM-in_PT-from_PT+FU"
