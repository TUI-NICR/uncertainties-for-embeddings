...
#SBATCH --output=/results_nas/ange8547/DNet/fastreid/pretrain_PT__rndsmpl/%a/slurm-%j.out

# specify job name that is seen in slurm info
#SBATCH --job-name=pretrain_PT__rndsmpl
...
def setup(args):
    ...
    cfg.run_type = "pre-Market-in_PT-from_TF+euclid_rndsmpl"
