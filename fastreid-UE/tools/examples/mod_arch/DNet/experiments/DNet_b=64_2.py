...
#SBATCH --output=/results_nas/ange8547/mod_arch/DNet/experiments/b64_2/%a/slurm-%j.out

# specify job name that is seen in slurm info
#SBATCH --job-name=DNet_b64_2
...
def change_out_dir(cfg):
    ...
    if slurm_array_id != None:
        ...
        OUTPUT_ADDENUM = os.path.join("experiments", "b64_2", str(slurm_array_id))
