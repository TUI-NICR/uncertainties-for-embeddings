...
#SBATCH --output=/results_nas/ange8547/mod_arch/DNet/experiments/b64/%a/slurm-%j.out

# specify job name that is seen in slurm info
#SBATCH --job-name=DNet_b64
...
def change_out_dir(cfg):
    ...
    cfg.SOLVER.BASE_LR = 0.0001 # double b, double eta
    cfg.SOLVER.IMS_PER_BATCH = 64

    slurm_array_id = get_array_id()
    if slurm_array_id != None:

        OUTPUT_ADDENUM = os.path.join("experiments", "b64", str(slurm_array_id))
