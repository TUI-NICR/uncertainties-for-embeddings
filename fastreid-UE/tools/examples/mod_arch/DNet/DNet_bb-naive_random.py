...
#SBATCH --output=/results_nas/ange8547/mod_arch/DNet/bb_naive/random/%a/slurm-%j.out

# specify job name that is seen in slurm info
#SBATCH --job-name=DNet_bb-naive_random
...
def change_out_dir(cfg):
    ...
    if slurm_array_id != None:
        ...
        OUTPUT_ADDENUM = os.path.join("bb_naive", "random", str(slurm_array_id))
