...
#SBATCH --output=/results_nas/ange8547/mod_arch/bagtricks/naive/%a/slurm-%j.out

# specify job name that is seen in slurm info
#SBATCH --job-name=pretrain_baseline_bagtricks__naive
...
def configure_volatile(cfg):
    ...
    if slurm_array_id != None:
        ...
        ADDENUM = os.path.join("naive", str(slurm_array_id))
