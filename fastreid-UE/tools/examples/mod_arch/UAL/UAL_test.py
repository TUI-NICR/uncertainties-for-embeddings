...
#SBATCH --output=/results_nas/ange8547/mod_arch/DNet/bb_random/naive/%a/slurm-%j.out

# specify job name that is seen in slurm info
#SBATCH --job-name=DNet_bb-random_naive
...
def change_out_dir(cfg):
    ...
    if slurm_array_id != None or True:
