...
#SBATCH --output=/results_nas/ange8547/mod_arch/UAL/Gaussian/%a/slurm-%j.out

# specify job name that is seen in slurm info
#SBATCH --job-name=UAL_Gaussian
...
def change_out_dir(cfg):
    ...
    if slurm_array_id != None:
        ...
        OUTPUT_ADDENUM = os.path.join("Gaussian", slurm_array_id)
