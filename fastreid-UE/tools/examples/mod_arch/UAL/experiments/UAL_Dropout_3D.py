...
#SBATCH --output=/results_nas/ange8547/mod_arch/UAL/experiments/Dropout_3D/%a/slurm-%j.out

# specify job name that is seen in slurm info
#SBATCH --job-name=UAL_Dropout_3D
...
def change_out_dir(cfg):
    ...
    if slurm_array_id != None:
        ...
        OUTPUT_ADDENUM = os.path.join("Dropout_3D", slurm_array_id)
